...
![强制浏览导致安全漏洞](/images/HTTP图解/11强制浏览导致安全漏洞.png)  
...
![Web应用抛出的错误信息](/images/HTTP图解/11Web应用抛出的错误信息.png)  
![数据库系统抛出的错误信息](/images/HTTP图解/11数据库系统抛出的错误信息.png)  
...
![会话劫持2](/images/HTTP图解/11会话劫持2.png)  

### 4.2 会话固定攻击
会话固定攻击攻击会强制用户使用攻击者指定的会话ID，属于被动攻击。  
![会话固定攻击](/images/HTTP图解/11会话固定攻击.png)  
...
![跨站点请求伪造的攻击](/images/HTTP图解/11跨站点请求伪造的攻击.png)  
...
![穷举或字典](/images/HTTP图解/11穷举或字典.png)  
...
![破解已加密的密码](/images/HTTP图解/11破解已加密的密码.png)  

### 5.2 点击劫持
点击劫持是指利用透明的按钮或链接做成陷阱，覆盖在Web页面上。然后诱使用户在不知情的情况下点击的一种攻击手段。

![点击劫持](/images/HTTP图解/11点击劫持.png)  
...
![DoS攻击](/images/HTTP图解/11DoS攻击.png)  
